    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-xs-12">
                    <?php
                        echo Html::a('&nbsp;&nbsp;LF&nbsp;&nbsp;', ['download', 'outBackup' => $outBackup, 'id' =>$id, 'hostname' => $hostname , 'put' => $put, 'hash' => $hash], [
                            'class'   => 'btn btn-primary pull-left',
                            'onclick' => '(function() { $("#download_modal").modal("hide"); })();'
                        ]);
                        echo Html::a('CRLF', ['download', 'outBackup' => $outBackup, 'hostname' => $hostname, 'id'=>$id, 'put' => $put, 'hash' => $hash, 'crlf' => true], [
