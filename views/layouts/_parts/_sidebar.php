        ...
        <?php
            ...
            echo \yii\widgets\Menu::widget([
                ...
                'items'           => [
                    ...
                    [
                        'label'           => '<i class="fa fa-folder"></i> <span>'.Yii::t('confBackups', 'Configuration backups').'</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>',
                        'url'             => ['/backup'],
                        'options'         => ['class' => 'treeview'],
                        'active'          => $checkRoute(['backup/list', 'backup/view']),
                        'items' => [
                            [
                                'label' => Yii::t('app', 'Nodes'),
                                'url'   => ['/backup/list'],
                                'active'  => $checkRoute(['backup/list']),
                            ]
                        ]
                    ],
                    $renderPluginMenu()
