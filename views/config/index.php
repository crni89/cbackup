...
<!------------------------------------------------ Number of backups -------------------------------------------------->
                <div class="box box-default">
                    <div class="box-header with-border">
                        <i class="fa fa-database"></i>
                        <h3 class="box-title"><?= Yii::t('config', 'Number of backups config') ?></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row">
                                    <?= ConfigHelper::formGroup('device_versions', $errors, [
                                        'label' => Yii::t('config', 'Number of backups configs'),
                                        'description' => Yii::t('config', 'Enter how many configs u want to save'),
                                        'input' => Html::textInput('Config[device_versions]', $data['device_versions'], ['class' => 'form-control']),
                                    ]) ?>
                                </div>
                            </div>
                        </div>
