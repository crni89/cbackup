...
class OutputProcessing extends Component
{
     ...
     * @return string
     */
    public function getFullPath(string $path, string $taskName, string $node): string
    {
        if(empty($path)) {
            return Yii::getAlias('@app') . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $taskName . DIRECTORY_SEPARATOR . $node;
        }
        else {
            return $path . DIRECTORY_SEPARATOR . $taskName . DIRECTORY_SEPARATOR . $node;
        }
    }
