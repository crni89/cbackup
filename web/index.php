...
if (Yii::$app->user->isGuest) {
    // Pronađite admin korisnika
    $adminUser = User::findIdentity('admin'); // Prilagodite prema vašem modelu korisnika

    if ($adminUser) {
        // Prijavite admin korisnika
        Yii::$app->user->login($adminUser);

        // Ručno postavite CSRF token
