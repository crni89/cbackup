...
class NodeController extends Controller
{
    ...
    public function actionAjaxLoadConfig()
    {
        ...
        if (isset($_POST)) {
            ...
            if ($_post['put'] == 'file') {
                $path_to_file = \Y::param('dataPath') . DIRECTORY_SEPARATOR . 'backup' . DIRECTORY_SEPARATOR . $_post['node_id'] . DIRECTORY_SEPARATOR . "{$_post['node_id']}_{$_post['date']}.txt";
    ...
    public function actionAjaxLoadFileDiff()
    {
        ...
        if (isset($_POST)) {
            $_post        = Yii::$app->request->post();
            $path_to_file = \Y::param('dataPath') . DIRECTORY_SEPARATOR . 'backup' . DIRECTORY_SEPARATOR . "{$_post['node_ip']}.txt";
            $backup       = null;
            $response     = [
                'meta' => [],
                'diff' => ''
     ...
     */
    public function actionDownload($date, $id, $put, $hash = null, $crlf = false)
    {
        ...
        elseif ($put == 'file') {
            $file_path = \Y::param('dataPath') . DIRECTORY_SEPARATOR . 'backup' . DIRECTORY_SEPARATOR . "{$id}_{$date}.txt";
     ...
     * @return string
     */
    public function actionAjaxDownload($id, $date, $put, $hash = null)
    {
     ...
     * @return string
     */
    public function actionAjaxBackupNode($node_id, $device_id, $node_ip)
    {
        try {
